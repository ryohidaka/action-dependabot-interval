...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.GIT_USER_NAME = exports.GIT_USER_EMAIL = exports.DEFAULT_COMMIT_MESSAGE = void 0;
exports.DEFAULT_COMMIT_MESSAGE = "Update dependabot.yml or dependabot.yaml";
exports.GIT_USER_EMAIL = "action@github.com";
exports.GIT_USER_NAME = "GitHub Action";
...
const getInputParameter = () => {
    try {
        ...
        const message = core.getInput("message") || constants_1.DEFAULT_COMMIT_MESSAGE;
        return {
            interval,
            message,
        };
        ...
        return {
            interval: types_1.Interval.Weekly,
            message: "",
        };
    }
};
...
function getInterval(intervalString) {
    switch (intervalString) {
        case types_1.Interval.Monthly:
            return types_1.Interval.Monthly;
        case types_1.Interval.Weekly:
            return types_1.Interval.Weekly;
        case types_1.Interval.Daily:
            return types_1.Interval.Daily;
        default:
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.findDependabotFilePath = void 0;
 ...
 */
const findDependabotFilePath = (dirPath = (0, path_1.join)(process.cwd(), ".github")) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const filesAndDirs = yield (0, promises_1.readdir)(dirPath, { withFileTypes: true });
        for (const dirent of filesAndDirs) {
            if (dirent.isFile() && isDependabotFile(dirent.name)) {
                return (0, path_1.join)(dirPath, dirent.name);
            }
        }
        throw new Error("No dependabot.yml or dependabot.yaml file found in the .github directory.");
    }
    catch (error) {
        throw new Error(`Error finding dependabot.yml or dependabot.yaml file in the .github directory: ${error.message}`);
    }
});
exports.findDependabotFilePath = findDependabotFilePath;
/**
 ...
 */
const isDependabotFile = (filename) => {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
__exportStar(__nccwpck_require__(624), exports);
__exportStar(__nccwpck_require__(4370), exports);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.modifyDependabot = void 0;
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        // Get input parameter.
        const { interval, message } = (0, lib_1.getInputParameter)();
        // Find dependabot.yaml path
        const path = yield (0, lib_1.findDependabotFilePath)();
        // Modify dependabot.yaml intervel value
        (0, lib_1.modifyDependabot)(path, interval);
        // Commit modified file
        (0, lib_1.commitFile)(message);
    });
}
void run();
